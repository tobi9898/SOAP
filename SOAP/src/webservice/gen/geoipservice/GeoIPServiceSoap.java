...
public interface GeoIPServiceSoap {
     ...
     * @param ipAddress
     * @return
     *     returns webservice.gen.geoipservice.GeoIP
     */
    ...
    @RequestWrapper(localName = "GetGeoIP", targetNamespace = "http://www.webservicex.net/", className = "webservice.gen.geoipservice.GetGeoIP")
    @ResponseWrapper(localName = "GetGeoIPResponse", targetNamespace = "http://www.webservicex.net/", className = "webservice.gen.geoipservice.GetGeoIPResponse")
    ...
    @RequestWrapper(localName = "GetGeoIPContext", targetNamespace = "http://www.webservicex.net/", className = "webservice.gen.geoipservice.GetGeoIPContext")
    @ResponseWrapper(localName = "GetGeoIPContextResponse", targetNamespace = "http://www.webservicex.net/", className = "webservice.gen.geoipservice.GetGeoIPContextResponse")
